...
const paymentSchema = new mongoose.Schema({
  ...
  currency: { type: String, required: true, default: "INR" }, // Payment currency (default is INR)
  order_status: { type: String, required: true, enum: ["success", "failed", "pending"], default: "pending" }, // Order status
