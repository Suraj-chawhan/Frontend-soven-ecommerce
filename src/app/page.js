...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className=" mt-450px] md:mt-[0px]">
      ...
      <div className="self-center w-full  flex gap-6 flex-col categories-section bg-gray-100 py-6 ">
        ...
        <div className="self-center flex gap-6 products-section  sm:flex-wrap">
      ...
      <div className="bg-gray-100 flex flex-col gap-8  py-8">
        ...
        <div className="self-center flex gap-8 products-section  sm:flex-wrap ">
          {loading
            ? Array(4)
                .fill(0)
                .map((_, index) => (
