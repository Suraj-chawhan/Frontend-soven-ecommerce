  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 text-gray-800">
      ...
      <p className="text-lg leading-relaxed mb-6">
        The information provided by Outfit eCommerce (“we,” “us” or “our”) on
        this website is for general informational purposes only. All information
      ...
      <p className="text-lg leading-relaxed mb-6">
        The site cannot and does not contain fashion advice. The fashion
      ...
      <p className="text-lg leading-relaxed">
        ...
        inability to use, the materials on this site, even if our authorized
